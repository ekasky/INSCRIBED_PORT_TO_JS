    ...
    return (
        ...
        >
            ...
            <VStack spacing={5} align="stretch">
                ...
                <Button leftIcon={<FaStream />} colorScheme="teal" variant="outline" as={RouterLink} to={FOR_YOU_FEED}>
                Follower Feed
                </Button>

                <Button leftIcon={<FaClipboardList />} colorScheme="teal" variant="outline" as={RouterLink} to={YOUR_POSTS}>
                Your Posts
                </Button>
